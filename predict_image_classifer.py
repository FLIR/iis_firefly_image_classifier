...
tf.app.flags.DEFINE_integer('num_classes', 26, 'The number of classes.')
tf.app.flags.DEFINE_string('infile','/home/docker/ahmed/datasets/blocks_test/test_1/test_1_list.csv', 'Image file, one image per line.')
tf.app.flags.DEFINE_boolean('tfrecord',False, 'Input file is formatted as TFRecord.')
tf.app.flags.DEFINE_string('outfile','/home/docker/ahmed/datasets/blocks_test/test_1/test_1_outlist.csv', 'Output file for prediction probabilities.')
tf.app.flags.DEFINE_string('model_name', 'mobilenet_v1_025', 'The name of the architecture to evaluate.')
tf.app.flags.DEFINE_string('preprocessing_name', 'custom_1_preprocessing_pipline', 'The name of the preprocessing to use. If left as `None`, then the model_name flag is used.')
tf.app.flags.DEFINE_string('checkpoint_path', 'train_dir/mobilenet_v1_blocks_all/compare_1/output_4/train/model.ckpt-23711','The directory where the model was written to or an absolute path to a checkpoint file.')
...
model_name_to_variables = {'mobilenet_v1_025':'MobilenetV1','inception_v3':'InceptionV3','inception_v4':'InceptionV4','resnet_v1_50':'resnet_v1_50','resnet_v1_152':'resnet_v1_152'}
...
for fl in fls:
  ...
  print(f'image name {a[0]} and class {a[-1]}')
sess.close()
fout.close()
